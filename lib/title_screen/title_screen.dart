...
class _TitleScreenState extends State<TitleScreen>
  ...
  late StreamSubscription<int> _difficultyStreamSubscription;
  ...
  void initState() {
    ...
    final random = Random();
    final difficultyStream = Stream<int>.periodic(
      Duration(seconds: 4),
      (_) => random.nextInt(3),
    );

    _difficultyStreamSubscription = difficultyStream.listen(
      (randomDifficulty) {
        _handleDifficultyPressed(randomDifficulty);
      },
    );
  }
  ...
  void dispose() {
    super.dispose();
    _difficultyStreamSubscription.cancel();
  }
